...
/**
 * brackets, num_brackets, branches, num_branches, caps, num_caps, flags
 */
struct regex_info {
  /**
...
/**************************************************
 * @brief поиск соответствия регулярному выражению
 * @note   
 * @param  regexp: Регулярное выражение
 * @param  s: строка для которой выполняется регекс
 * @param  s_len: длина этой строки
 * @param  caps: хэндл для скобок
 * @param  num_caps: кол-во скобочных групп
 * @param  flags: флаги
 * @retval 
 *************************************************/
